...
rootdir: /vols/pytest_27710, inifile: pytest.ini
...
tests/asiaservers_test.py:7
  /vols/pytest_27710/tests/asiaservers_test.py:7: DeprecationWarning: invalid escape sequence \s
    assert host.file("/etc/issue").contains("Region:\s*asia")

tests/ukservers_test.py:7
  /vols/pytest_27710/tests/ukservers_test.py:7: DeprecationWarning: invalid escape sequence \s
...
Revision: ba20e5078047115dd054d8c49da37a3d